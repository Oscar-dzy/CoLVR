...
def single_input_image_preprocess_function_vanilla_sft(sample):
    # Load images
...
def single_input_image_preprocess_progressive_state_function(sample):
    # Load images
    ...
    return conversations, end_state_conversations
...
task_preporcess_config = {
    'vsp-spatial-planning-vanilla-sft': single_input_image_preprocess_function_vanilla_sft,
    'vsp-spatial-planning': single_input_image_preprocess_function,
    'vsp-spatial-planning-progressive': single_input_image_preprocess_progressive_state_function,
    'jigsaw-vanilla-sft': single_input_image_preprocess_function_vanilla_sft,
    'jigsaw-mirage': single_input_image_preprocess_function,
    'jigsaw-progressive': single_input_image_preprocess_progressive_state_function,
    'tertis-vanilla-sft': single_input_image_preprocess_function_vanilla_sft,
    'tertis-mirage': single_input_image_preprocess_function,
    'tertis-progressive': single_input_image_preprocess_progressive_state_function,
}

task_test_preporcess_config = {
    'vsp-spatial-planning': single_input_image_test_preprocess_function,
    'vsp-spatial-planning-progressive': single_input_image_test_preprocess_function,
    'jigsaw': single_input_image_test_preprocess_function,
    'jigsaw-progressive': single_input_image_test_preprocess_function,
    'tertis': single_input_image_test_preprocess_function,
    'tertis-progressive': single_input_image_test_preprocess_function,
}
